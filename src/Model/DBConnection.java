...
public class DBConnection {
     ...
     */
    public DBConnection(String nameDatabase, String loginDatabase, String passwordDatabase) throws SQLException, ClassNotFoundException {
     ...
     public static Connection getDBConnection()
    {
        ...
        try {
            ...
            {
            Class.forName("com.mysql.jdbc.Driver");
            con = DriverManager.getConnection("jdbc:mysql://localhost/hopital","root", "root");
